...
public class Vehicle {
	public String id = "";
	public ArrayList<RouteLeg> routeLegs = new ArrayList<>(10);
	// Trajectories added on 26/01/2021 - contains for each vehicle its timestamped coordinates
	public ArrayList<VehicleTrajectory> trajectories = new ArrayList<>(10);
    ...
    /**
     * The actual worker id (fellow on the same JVM must recognize your vehicles)
     */
