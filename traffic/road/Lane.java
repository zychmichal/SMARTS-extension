...
public class Lane {
	...
	public Lane copyThisLane(final Edge edge){
	    Lane copyLane = new Lane(edge);
	    copyLane.laneNumber = this.laneNumber;
	    copyLane.index = this.index;
	    copyLane.isBlocked = this.isBlocked;
	    copyLane.speedOfLatestVehicleLeftThisWorker = this.speedOfLatestVehicleLeftThisWorker;
	    copyLane.endPositionOfLatestVehicleLeftThisWorker = this.endPositionOfLatestVehicleLeftThisWorker;
	    copyLane.isPriority = this.isPriority;
	    copyLane.latStart = this.latStart;
	    copyLane.latEnd = this.latEnd;
	    copyLane.latLength = this.latLength;
	    copyLane.lonEnd = this.lonEnd;
	    copyLane.lonLength = this.lonLength;
	    copyLane.lonStart = this.lonStart;
	    return copyLane;
    }
}
