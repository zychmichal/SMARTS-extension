...
public class GraphGenerator {
    ...
    public Map<Integer,GridCell> indexCellGraph = new HashMap<>();
    ...
    public List<IntSet> computePartitions(int numParts, Map<String, GridCell> workCellsSet) {
        ...
        Collection<IntSet> sets = new Metis().compute(this.graph, indexCellGraph, numParts, new Random(), workCellsSet);
