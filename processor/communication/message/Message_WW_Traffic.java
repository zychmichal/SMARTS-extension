...
public class Message_WW_Traffic {
	...
	ArrayList<SerializableVehicleTrajectory> getSerializableTrajectories(final Vehicle vehicle) {
		final ArrayList<SerializableVehicleTrajectory> trajectoryList = new ArrayList<>();
		for (final VehicleTrajectory trajectory : vehicle.trajectories) {
			trajectoryList.add(new SerializableVehicleTrajectory(trajectory.timeStamp, trajectory.lat, trajectory.lon));
		}
	...
	SerializableVehicle getSerializableVehicle(final Vehicle vehicle) {
		...
		serializableVehicle.trajectories = getSerializableTrajectories(vehicle);
