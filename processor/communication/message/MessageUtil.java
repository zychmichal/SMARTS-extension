...
public class MessageUtil {
	...
	public static Object read(final String message) {
		...
		try {
			...
			e.printStackTrace();
			rootLogger.error("Exception in MessageUtil.read()", e);
		}
		return object;
	}
	...
	static void updateObjectWithMessageData(final Object object, final String data, final int level) {
		try {
			...
			e.printStackTrace();
			rootLogger.error("Exception in MessageUtil.updateObjectWithMessageData()", e);
		}
	}
	...
	void appendObjectToMessage(final Object object, final int level) {
		try {
			...
			e.printStackTrace();
			rootLogger.error("IllegalArgumentException in MessageUtil.appendObjectToMessage()", e);
		} catch (IllegalAccessException e) {
			e.printStackTrace();
			rootLogger.error("IllegalAccessException in MessageUtil.appendObjectToMessage()", e);
		}
	}
