...
public class Settings {
	...
	public static int trafficReportStepGapInServerlessMode = 10000;
	 ...
	 */
	public static boolean isServerBased = false;//Whether workers receive instructions from server for each step	DEFAULT: true
    ...
    public static int numManWorkers = 1;//Number of workers manager that run simulation in parallel
	...
	public static String prefixOutputTrajectory = "results/Trajectory_";//Time-stamped GPS trajectory of vehicles
	public static String prefixOutputRoutePlan = "results/Route_";//Route plan of vehicles that have appeared in simulation
	public static String prefixOutputTravelTime = "results/TravelTime_";//Travel time of vehicles that have appeared in simulation
	public static String prefixOutputSimLog = "results/Log_";//General statistic, e.g., simulation time
	 ...
	 * Other
	 */
	public static String close_pill = "__close_pill__";
	// sending messages to worker asynchornously on 24 processors instead of synchronized sending
	public static boolean parallelMessageSending = true;
	public static boolean collectTrajectoryInWorkers = true;
}
